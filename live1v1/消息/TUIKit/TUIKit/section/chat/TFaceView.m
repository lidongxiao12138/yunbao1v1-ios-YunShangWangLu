...
@interface TFaceView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews
{
    ...
    [_faceCollectionView registerClass:[TFaceCell class] forCellWithReuseIdentifier:TFaceCell_ReuseId];
...
{
    TFaceCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TFaceCell_ReuseId forIndexPath:indexPath];
