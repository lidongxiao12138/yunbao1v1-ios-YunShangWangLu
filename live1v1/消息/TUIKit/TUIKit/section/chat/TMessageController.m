                ...
                if ([dic valueForKey:@"method"]) {
                    ...
                    if ([minstr([dic valueForKey:@"method"]) isEqual:@"call"]) {
                        ...
                        switch (action) {
                            case 0:
                                if (msg.isSelf) {
                                    callData.content = @"发起聊天";
                                }else{
                                    callData.content = @"对方发起聊天";
                                }
                                break;
                            case 1:
                                if (msg.isSelf) {
                                    callData.content = @"已取消";
                                }else{
                                    callData.content = @"对方已取消";
                                }
                                break;
                            case 2:
                                if (msg.isSelf) {
                            ...
                            case 4:
                                if (msg.isSelf) {
                                    callData.content = @"已接听";
                                }else{
                                    callData.content = @"对方已接听";
                                }
                                break;
                            case 5:
                                if (msg.isSelf) {
                                    callData.content = @"已拒绝";
                                }else{
                                    callData.content = @"对方已拒绝";
                                }
                                break;
                            case 6:
                                if (msg.isSelf) {
...
- (void)sendMessage:(TMessageCellData *)msg
{
    ...
    __weak typeof(self) ws = self;
//    [conv sendOnlineMessage:imMsg succ:^{
