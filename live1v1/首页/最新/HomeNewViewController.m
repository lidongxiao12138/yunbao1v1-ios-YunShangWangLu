...
@interface HomeNewViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>{
    CGFloat oldOffset;
    int page;
}
...
-(void)pullInternet{
    ...
    [YBToolClass postNetworkWithUrl:[NSString stringWithFormat:@"Home.getNew&lat=%@&lng=%@",[cityDefault getMylat],[cityDefault getMylng]] andParameter:@{@"p":@(page)} success:^(int code,id info,NSString *msg) {
