...
-(void)setContentFrame{
    [_contentView setContentOffset:CGPointMake(_window_width*self.curIndex,0) animated:NO];
}
...
//    CGFloat contentTopEdging = _contentTopEdging + [self statusBarHeight] + statusbarHeight;
    if (self.type == 0) {
        ...
        _contentView.frame = CGRectMake(0, 64+statusbarHeight, _window_width, _window_height-64-statusbarHeight);
    }else{
        _contentView.frame = CGRectMake(0, 40, _window_width, _window_height-104-statusbarHeight);
    }
