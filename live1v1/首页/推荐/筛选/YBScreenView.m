...
- (void)creatUI{
    whiteView = [[UIView alloc]initWithFrame:CGRectMake(0, _window_height, _window_width, 270+ShowDiff)];
...
- (void)show{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        whiteView.y = _window_height-270-ShowDiff;
    }];
