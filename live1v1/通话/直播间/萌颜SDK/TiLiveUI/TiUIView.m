...
- (instancetype)initTiUIViewWith:(TiSDKManager *)tiSDKManager delegate:(id<TiUIViewDelegate>)delegate superView:(UIView *)superView {
    ...
    _fitterNameArray = @[@"orginalti",@"langmanti",@"qingxinti",@"weimeiti",@"fennenti",@"huaijiuti",@"qingliangti",@"landiaoti",@"meibaiti",@"rixiti"];
    _rockEnumIndex = -1;
    _filterEnumIndex = -1;
...
- (UIScrollView *)mainMenuView {
    if (!_mainMenuView) {
        ...
        [_mainMenuView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)selectLine{
    if (!_selectLine) {
        ...
        _selectLine.backgroundColor = RGB_COLOR(@"#ffffff", 1);
    }
    return _selectLine;
}
// 绘制美颜选择按钮
- (UIButton *)selectBeautyButton {
    if (!_selectBeautyButton) {
        ...
        [_selectBeautyButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectBeautyButton.right, _selectBeautyButton.top, 1, _selectBeautyButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        [_selectBeautyButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectFaceTrimButton {
    if (!_selectFaceTrimButton) {
        ...
        [_selectFaceTrimButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectFaceTrimButton.right, _selectFaceTrimButton.top, 1, _selectFaceTrimButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        _selectFaceTrimButton.titleLabel.font = [UIFont systemFontOfSize:15];

        [_selectFaceTrimButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectStickerButton {
    if (!_selectStickerButton) {
        ...
        [_selectStickerButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectStickerButton.right, _selectStickerButton.top, 1, _selectStickerButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        _selectStickerButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [_selectStickerButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectFilterButton {
    if (!_selectFilterButton) {
        ...
        [_selectFilterButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectFilterButton.right, _selectFilterButton.top, 1, _selectFilterButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        _selectFilterButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [_selectFilterButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectRockButton {
    if (!_selectRockButton) {
        ...
        [_selectRockButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectRockButton.right, _selectRockButton.top, 1, _selectRockButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        _selectRockButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [_selectRockButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectDistortionButton {
    if (!_selectDistortionButton) {
        ...
        [_selectDistortionButton setTitleColor:RGB_COLOR(@"#C8C8C8", 1) forState:0];
//        [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(_selectRockButton.right, _selectRockButton.top, 1, _selectRockButton.height) andColor:RGB_COLOR(@"#C8C8C8", 1) andView:_mainMenuView];
        _selectDistortionButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [_selectDistortionButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIButton *)selectGreenScreenButton {
    if (!_selectGreenScreenButton) {
        ...
        [_selectGreenScreenButton setTitleColor:RGB_COLOR(@"#ffffff", 1) forState:UIControlStateSelected];
...
- (UIView *)beautyView {
    if (!_beautyView) {
        ...
        [_beautyView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)faceTrimView {
    if (!_faceTrimView) {
        ...
        [_faceTrimView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)stickerView {
    if (!_stickerView) {
        ...
        [_stickerView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)filterView {
    if (!_filterView) {
        ...
        [_filterView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)rockView {
    if (!_rockView) {
        ...
        [_rockView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UIView *)distortionView {
    if (!_distortionView) {
        _distortionView = [[UIView alloc] initWithFrame:CGRectMake(0, TiScreenHeight, TiScreenWidth, 90)];
        [_distortionView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
- (UICollectionView *)distortionCollectionView {
    if (!_distortionCollectionView) {
        ...
        _distortionCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, TiScreenWidth, 101) collectionViewLayout:flowLayout];
        //注册cell
...
- (UIView *)greenScreenView {
    if (!_greenScreenView) {
        ...
        [_greenScreenView setBackgroundColor:TiRGBA(0, 0, 0, 0.9)];
...
//        [((TiUICell *) cell) setFilterUICellByIndex:indexPath.item];
        ...
        [((TiUICell *) cell) setDistortionUICellByIndex:indexPath.item];
    } else if (collectionView == self.greenScreenCollectionView) {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:TiUICellIdentifier forIndexPath:indexPath];
        [cell sizeToFit];
