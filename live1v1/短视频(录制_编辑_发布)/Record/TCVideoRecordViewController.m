...
-(void)initUI {
    ...
    [_btnCamera setTitle:@"翻转" forState:0];
    _btnCamera.titleLabel.font = SYS_Font(11);
    _btnCamera = [YBToolClass setUpImgDownText:_btnCamera];
    ...
    [_btnLamp setTitle:@"闪光灯" forState:0];
    _btnLamp.titleLabel.font = SYS_Font(11);

    _btnLamp = [YBToolClass setUpImgDownText:_btnLamp];
    ...
    _btnBeauty = [YBToolClass setUpImgDownText:_btnBeauty];
    ...
    [musicBtn setTitle:@"音乐" forState:0];
    musicBtn.titleLabel.font = SYS_Font(11);
    musicBtn = [YBToolClass setUpImgDownText:musicBtn];
    ...
    [_btnLocalVideo setTitle:@"上传" forState:UIControlStateNormal];
    _btnLocalVideo.titleLabel.font = SYS_Font(11);
    _btnLocalVideo = [YBToolClass setUpImgDownText:_btnLocalVideo];
    ...
    _progressView.progressTintColor = normalColors;//UIColorFromRGB(0X0ACCAC);
    _progressView.tintColor = colorf5;
...
-(void)zhuanma:(NSString *)videlPathsss{
    ...
    NSString *random = [YBToolClass getNameBaseCurrentTime:@""];
    ...
    [exportSession exportAsynchronouslyWithCompletionHandler:^{
        ...
        switch (exportStatus) {
            case AVAssetExportSessionStatusFailed:
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [MBProgressHUD hideHUD];
                    [MBProgressHUD showError:@"转码失败,请更换视频"];
                });
                break;
...
-(void)onBtnCloseClicked {
    ...
    UIAlertAction *restAction = [UIAlertAction actionWithTitle:@"重新拍摄" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
-(void)initBeautyUI {
    ...
    [_beautyBtn setTitleColor:normalColors forState:UIControlStateSelected];//UIColorFromRGB(0x0ACCAC)
    ...
    [_filterBtn setTitleColor:normalColors forState:UIControlStateSelected];//UIColorFromRGB(0x0ACCAC)
    ...
    [_motionBtn setTitleColor:normalColors forState:UIControlStateSelected];//UIColorFromRGB(0x0ACCAC)
    ...
    [_greenBtn setTitleColor:normalColors forState:UIControlStateSelected];//UIColorFromRGB(0x0ACCAC)
...
- (void)onDeleteBtnClicked{
    UIAlertController *alertContro = [UIAlertController alertControllerWithTitle:@"确定删除上一段视频" message:nil preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancleAction = [UIAlertAction actionWithTitle:@"取消" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    }];
    [alertContro addAction:cancleAction];
