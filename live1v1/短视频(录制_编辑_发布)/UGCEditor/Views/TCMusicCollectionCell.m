...
- (void)setSelected:(BOOL)selected
{
    ...
    if (!selected) {
        ...
        _songNameLabel.textColor = normalColors;//UIColorFromRGB(0x0accac);
        _authorNameLabel.textColor = normalColors;//UIColorFromRGB(0x0accac);
        self.layer.borderWidth = 1;
        self.layer.borderColor = normalColors.CGColor;//UIColorFromRGB(0x0accac).CGColor;
    }
}
