...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_btnCut setTitleColor:color66 forState:0];
        [_btnCut setTitleColor:normalColors forState:UIControlStateSelected];
        ...
        [_btnTime setTitleColor:color66 forState:0];
        [_btnTime setTitleColor:normalColors forState:UIControlStateSelected];
        ...
        [_btnEffect setTitleColor:color66 forState:0];
        [_btnEffect setTitleColor:normalColors forState:UIControlStateSelected];
