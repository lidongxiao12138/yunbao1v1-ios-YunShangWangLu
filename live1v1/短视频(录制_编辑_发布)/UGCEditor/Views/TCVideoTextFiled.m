...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _borderView.layer.borderColor = normalColors.CGColor;//UIColorFromRGB(0x0accac).CGColor;
        ...
        _inputConfirmBtn.backgroundColor = normalColors;// UIColorFromRGB(0x0accac);
