...
-(void)pullData {
    [YBToolClass postNetworkWithUrl:@"Music.getCLass" andParameter:nil success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 0) {
            _dataArray = info;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *coverStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"thumb"]];
