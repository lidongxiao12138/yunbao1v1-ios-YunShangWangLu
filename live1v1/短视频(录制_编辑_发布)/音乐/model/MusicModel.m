...
-(instancetype)initWithDic:(NSDictionary *)dic{
    ...
    if (self) {
        ...
        _bgStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"thumb"]];
        _timeStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"length"]];
        _urlStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"href"]];
        _useNumsStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"use_nums"]];
        _isCollectStr = [NSString stringWithFormat:@"%@",[dic valueForKey:@"iscollection"]];
    }
    return self;
}
